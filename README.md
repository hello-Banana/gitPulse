...
# 序号   作者                                  提交数   标签        
# ──────────────────────────────────────────────────────────────
# 1    digua <i@digua.me>                    37   👑 卷王      
# 2    contributor <contrib@example.com>     15   ✓ 活跃
...
# 排名   作者                                 提交数    加班比例  标签          
# ──────────────────────────────────────────────────────────────────────
# 1    digua <i@digua.me>                  37        54%  👑 卷王         🥇
# 2    contributor <contrib@example.com>   15        20%  ✓ 活跃          🥈
# 
# 🏆 卷王榜 Top 3:
#   1. digua <i@digua.me> - 卷王指数：77 (提交：37, 加班：54%)
```
...
| `--authors` | | 列出所有作者及提交数 | `--authors` |
| `--team` | | 团队贡献分析（含卷王榜） | `--team` |
...
| 标签 | 说明 |
|------|------|
| 👑 卷王 | 提交数 Top 20% 且加班比例>40% |
| 💪 骨干 | 提交数 Top 40% 且加班比例>30% |
| ✓ 活跃 | 提交数占总数的 40% 以上 |
| ○ 参与 | 提交数占总数的 20% 以上 |
| △ 偶尔 | 偶尔贡献 |
| 潜水员 | 无提交记录 |
